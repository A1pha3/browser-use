...
<div className="mb-8">
  ...
  <span className="text-sm px-3 py-1 bg-blue-100 text-blue-800 rounded-full">参考手册</span>
</div>
...
| 目标层级 | 描述 | 检验标准 |
|---------|------|---------|
| **记忆** | 查阅 Browser 参数表完成配置 | 能快速定位所需参数 |
| **理解** | 解释各参数的适用场景 | 能根据需求选择合适的配置 |
| **应用** | 配置满足生产环境需求的浏览器 | 能完成完整的浏览器配置 |
